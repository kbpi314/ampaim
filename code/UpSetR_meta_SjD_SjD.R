...
pdf(file='/Users/KevinBu/Desktop/clemente_lab/Projects/ampaim/outputs/jobs100/LEfSe_UpSetR_SjD_SjD.pdf',
    width=8,
    height=8)
...
# query indiv sets
df <- df_int[df_int$int == 'AMPAIM.SjD_AIMD|Valid3SjD.SjD_AIMD', ]
df$gene
