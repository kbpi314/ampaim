...
col1 <- c("#4F9AA6", "#FB9A99", "#EB5037", "#FE9425" ) # remove PsA color since not yet in dataset, no healthy bc pairwise comp to HC
...
print(p)
ggsave(fpb, plot = p, width = 8, height = 6, units = "in", dpi = 300)
