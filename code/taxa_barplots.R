...
metadata <- read_q2metadata("/Users/KevinBu/Desktop/clemente_lab/Projects/ampaim/inputs/Q2_MSQ138_141_noctrl_noeiser_nocd_correct/qiime_mapping_file_batch_nocd.tsv")

# table <- read_qza("taxa_table_L7.qza")$data
table <- read_qza("/Users/KevinBu/Desktop/clemente_lab/Projects/ampaim/inputs/Q2_MSQ138_141_noctrl_noeiser_nocd_correct/filtered_table.qza")$data

# taxonomy <- read_qza("taxonomy.qza")$data %>% parse_taxonomy()  
taxonomy <- read_qza("/Users/KevinBu/Desktop/clemente_lab/Projects/ampaim/inputs/Q2_MSQ138_141_noctrl_noeiser_nocd_correct/taxonomy.qza")$data %>% parse_taxonomy()  
