...
# read inputs
sp_taxasums = read.csv(file='/Users/KevinBu/Desktop/clemente_lab/Projects/ampaim/outputs/jobs27/df_q2R.tsv', 
                         sep='\t',
                         row.names='Genus')
...
pdf(file = '/Users/KevinBu/Desktop/clemente_lab/Projects/ampaim/outputs/jobs27/stacked_barplot.pdf', height = 4, width = 6)
plot(p)
dev.off()
