...
# read in metadata
metadata=read_delim(file='/Users/KevinBu/Desktop/clemente_lab/Projects/ampaim/outputs/jobs27/df_map.tsv',
                    delim='\t')#,row
metadata=metadata[-1,]


# read inputs PHYLUM
sp_taxasums = read.csv(file=paste0('/Users/KevinBu/Desktop/clemente_lab/Projects/ampaim/outputs/jobs27/df_q2R_L3.tsv'), 
                           sep='\t',
                           row.names='Phylum')
...
pdf(file = paste0('/Users/KevinBu/Desktop/clemente_lab/Projects/ampaim/outputs/jobs27/stacked_barplot_L3.pdf'), height = 4, width = 6)
plot(p)
dev.off()
  

# read inputs GENUS
sp_taxasums = read.csv(file=paste0('/Users/KevinBu/Desktop/clemente_lab/Projects/ampaim/outputs/jobs27/df_q2R_L6.tsv'), 
                       sep='\t',
                       row.names='Genus')
...
pdf(file = paste0('/Users/KevinBu/Desktop/clemente_lab/Projects/ampaim/outputs/jobs27/stacked_barplot_L6.pdf'), height = 4, width = 6)
plot(p)
dev.off()
