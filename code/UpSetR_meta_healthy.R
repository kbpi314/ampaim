...
listInput <- list(
  ...
  Luca2024.PsO_HC = list(read.table(file='/Users/KevinBu/Desktop/clemente_lab/Projects/ampaim/outputs/jobs100/Luca2024_PsO_HC.tsv', sep='\t',header=TRUE)$Taxa)[[1]],
  ...
  Wang2022.SjD_HC = list(read.table(file='/Users/KevinBu/Desktop/clemente_lab/Projects/ampaim/outputs/jobs100/Wang2022_SjD_HC.tsv', sep='\t',header=TRUE)$Taxa)[[1]]
...
# query indiv sets
df <- df_int[df_int$int == 'AMPAIM.RA_HC|AMPAIM.SLE_HC|Yu2022.RA_HC',]
df <- df_int[df_int$int == 'Su2020.SLE_HC|Yu2022.RA_HC',]
df <- df_int[df_int$int == 'AMPAIM.PsA_HC|AMPAIM.RA_HC|AMPAIM.SLE_HC|Su2020.SLE_HC',]
