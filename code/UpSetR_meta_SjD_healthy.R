...
pdf(file='/Users/KevinBu/Desktop/clemente_lab/Projects/ampaim/outputs/jobs100/LEfSe_UpSetR_SjD_healthy.pdf',
    width=8,
    height=8)
...
df<-df_int[df_int$int == 'AMPAIM.SjD_HC|Valid3SjD.SjD_HC',]
df$gene
