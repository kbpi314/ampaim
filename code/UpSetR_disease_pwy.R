...
listInput <- list(
  ...
  SS = list(read.table(file='/Users/KevinBu/Desktop/clemente_lab/Projects/ampaim/outputs/jobs06/UpSetR/SS_sig.tsv', sep='\t', header=TRUE)$Pathway)[[1]],
...
pdf(file='/Users/KevinBu/Desktop/clemente_lab/Projects/ampaim/outputs/jobs06/UpSetR/UpSetR_disease.pdf',
    width=6,
    height=6)
