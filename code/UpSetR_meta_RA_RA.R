...
pdf(file='/Users/KevinBu/Desktop/clemente_lab/Projects/ampaim/outputs/jobs100/LEfSe_UpSetR_RA_RA.pdf',
    width=8,
    height=8)
...
# query indiv sets
df <- df_int[df_int$int == 'Valid4RA.RA_AIMD|Valid7RA.RA_AIMD',]
