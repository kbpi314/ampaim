...
# the order we want is bottom up PsA NSS PsO SS RA SLE

col1 <- c(col2[3], col2[7], col2[4], col2[6], col2[2], col2[5])
...
listInput <- list(
  ...
  SjD = list(read.table(file='/Users/KevinBu/Desktop/clemente_lab/Projects/ampaim/outputs/jobs06/UpSetR/SS_healthy_sig.tsv', sep='\t',header=TRUE)$Pathway)[[1]],
...
pdf(file='/Users/KevinBu/Desktop/clemente_lab/Projects/ampaim/outputs/jobs27/UpSetR_pwy_healthy.pdf',
    width=6,
    height=6)
